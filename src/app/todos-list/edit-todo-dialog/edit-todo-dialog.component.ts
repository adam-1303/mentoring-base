...
@Component({
   ...
   standalone: true,
   imports: [ReactiveFormsModule,MatDialogClose,MatError,MatIconModule,MatFormFieldModule]
})
...
export class EditTodoDialogComponent {
   readonly data = inject<{todo: Todo}>(MAT_DIALOG_DATA)
      ...
      public form = new FormGroup({
            "userId": new FormControl(this.data.todo.userId, [Validators.required, Validators.minLength(3)]),
